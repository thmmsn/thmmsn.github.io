    ...
    return (
      <div className="choose-characters">
        ...
        <div className="row">
          ...
          <div className="col-sm-6">
            <div className="panel panel-default">
              <div className="panel-heading">Kanji</div>
              <div className="panel-body selection-areas">
                {this.showGroupRows('kanji', this.state.showAlternatives.indexOf('kanji') >= 0)}
              </div>
              <div className="panel-footer text-center">
                <a href="javascript:;" onClick={()=>this.selectAll('kanji')}>All</a> &nbsp;&middot;&nbsp; <a href="javascript:;"
                  onClick={()=>this.selectNone('kanji')}>None</a>
                &nbsp;&middot;&nbsp; <a href="javascript:;" onClick={()=>this.selectAll('kanji', true)}>All alternative</a>
                &nbsp;&middot;&nbsp; <a href="javascript:;" onClick={()=>this.selectNone('kanji', true)}>No alternative</a>
              </div>
            </div>
          </div>
